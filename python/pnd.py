#!/usr/bin/python3
# from https://gist.github.com/cnelson/1658752
...
class ProcNetDev(object):
    ...
    def update(self):
        ...
        headerline = self.proc.readline().decode("utf-8")
        ...
        #now get the labels
        labelline = self.proc.readline().decode('utf-8').strip("\n")
        labels = []
